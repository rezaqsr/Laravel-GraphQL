...
use App\GraphQL\Mutation\DeleteMutation;
use App\GraphQL\Mutation\NewMovieMutation;
use App\GraphQL\Mutation\UpdateMovieMutation;
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'directors' => DirectorsQuery::class,
                'genres' => GenresQuery::class,
            ],
            'mutation' => [
                NewMovieMutation::class,
                UpdateMovieMutation::class,
